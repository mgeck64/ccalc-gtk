    ...
    cancel_btn("_Cancel")
{
    ...
    input_defaults_vbox.append(input_defaults_lbl);
    input_defaults_lbl.set_text("Input Defaults");
    input_defaults_lbl.set_margin_bottom(default_margin);
    input_defaults_lbl.set_halign(Gtk::Align::START);

    input_defaults_vbox.append(input_defaults_hbox);

    input_defaults_hbox.append(default_number_type_code_cb);
    ...
    input_defaults_hbox.append(default_number_radix_cb);
    ...
    output_base_lbl.set_halign(Gtk::Align::START);

    settings_grid.attach(output_radix_cb, 2, 2, 1, 1);
    output_radix_cb.set_halign(Gtk::Align::END);
    ...
    output_fp_normalized_lbl.set_halign(Gtk::Align::START);

    settings_grid.attach(output_fp_normalized_switch, 2, 3, 1, 1);
    output_fp_normalized_switch.set_margin(default_margin);
    output_fp_normalized_switch.set_halign(Gtk::Align::END);
    ...
    precision_lbl.set_halign(Gtk::Align::START);
    ...
    integer_word_size_lbl.set_halign(Gtk::Align::START);

    settings_grid.attach(int_word_size_cb, 2, 5, 1, 1);
    int_word_size_cb.set_halign(Gtk::Align::END);
